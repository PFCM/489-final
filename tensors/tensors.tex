...
To show that allowing a tensor product allows a two layer network to achieve the same goal, we
...
minimum and maximum across all runs. Baseline cross entropy is 0.6931, corresponding to outputting
0.5 for all input (or guessing uniformly at random).}
