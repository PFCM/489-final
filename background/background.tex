...
To train such a network we need a set of inputs
...
\hl{Too general for here, maybe move to introduction?}
...
and Neural GPUs \autocite{Kaiser2015}. All of these involve adding fairly complex structures on
