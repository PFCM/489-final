...
The performance of the LSTM is somewhat disappointing. Of all the models it has the most parameters and 
should have the
...
All models were constrained to have a budget of 25,000 parameters (including the output layer but
